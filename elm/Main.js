...
var $author$project$Utils$Types$AppMode$Production = {$: 'Production'};
...
var $author$project$Main$Definitions$Flags = F3(
	function (randomNumbers, logo, mode) {
		return {logo: logo, mode: mode, randomNumbers: randomNumbers};
	});
...
var $author$project$Utils$Types$AppMode$Development = {$: 'Development'};
...
var $author$project$Utils$Types$AppMode$decoder = $dillonkearns$elm_ts_json$TsJson$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$dillonkearns$elm_ts_json$TsJson$Decode$literal,
			$author$project$Utils$Types$AppMode$Development,
			$elm$json$Json$Encode$string('development')),
			$dillonkearns$elm_ts_json$TsJson$Decode$succeed($author$project$Utils$Types$AppMode$Production)
		]));
...
var $author$project$Main$Definitions$flags = A2(
	...
	A2($dillonkearns$elm_ts_json$TsJson$Decode$field, 'mode', $author$project$Utils$Types$AppMode$decoder),
	A2(
		$dillonkearns$elm_ts_json$TsJson$Decode$andMap,
...
var $author$project$Utils$Types$Error$Decoding = function (a) {
	return {$: 'Decoding', a: a};
};
var $author$project$Utils$Types$Error$decoding = function (_v0) {
	var error = _v0.error;
	...
	return {
		...
		error: $author$project$Utils$Types$Error$Decoding(error),
		inModule: inModule
	};
};
...
var $author$project$Main$Update$BreakFile$BreakResult = F2(
	function (newFileContent, changes) {
		return {changes: changes, newFileContent: newFileContent};
	});
var $author$project$Utils$Tuple$map2 = F2(
	function (func, _v0) {
		var a = _v0.a;
		var b = _v0.b;
		return A2(func, a, b);
...
var $author$project$Main$Update$BreakFile$determineChoiceProbability = function (_v0) {
...
var $author$project$Utils$List$pickRandom = F2(
	function (seed, list) {
		...
		if (listSize > 0) {
			...
			return A2($elm_community$list_extra$List$Extra$getAt, index, list);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
...
var $author$project$Main$Update$BreakFile$chooseBreakType = F2(
	function (segments, breakTypeInt) {
		...
		var breakTypeProbabilities = A2(
			...
			function (_v1) {
				...
				return _Utils_Tuple2(
					breakType,
					$author$project$Main$Update$BreakFile$determineChoiceProbability(
...
var $author$project$Main$Update$BreakFile$getSeeds = F2(
			...
			var newFuncString = function () {
				switch (fileType.$) {
					case 'Elm':
						...
						return $elm_community$string_extra$String$Extra$clean(
							name + (' ' + (A2($elm$core$String$join, ' ', _arguments) + ' =')));
					case 'JavaScript':
						var _v8 = newFuncData;
						var declarationWord = _v8.declarationWord;
						var name = _v8.name;
						var _arguments = _v8._arguments;
						return (declarationWord === 'function') ? $author$project$Utils$Types$NamedFunctionDeclaration$toString(newFuncData) : (declarationWord + (' ' + (name + (' = (' + (A2($elm$core$String$join, ', ', _arguments) + ') => ')))));
					default:
...
var $author$project$Main$Update$BreakFile$selectFileChangesHelper = F3(
	function (config, segments, changes) {
		selectFileChangesHelper:
		while (true) {
			var _v0 = A2($author$project$Main$Update$BreakFile$getSeeds, config.breakCount, config.randomNumbers);
			var breakTypeChoiceSeed = _v0.a;
			var segmentChoiceSeed = _v0.b;
			var maybeBreakType = A2($author$project$Main$Update$BreakFile$chooseBreakType, segments, breakTypeChoiceSeed);
			var breakRunnerData = {
			...
			if (maybeChange.$ === 'Just') {
				...
				if (config.breakCount === 1) {
					...
					continue selectFileChangesHelper;
				}
			} else {
...
var $author$project$Main$Update$BreakFile$randomlySelectFileChangesFromParsedSegments = F2(
	function (config, segments) {
		return A2(
			$author$project$Utils$Tuple$map2,
			$author$project$Main$Update$BreakFile$BreakResult,
			A2(
				$elm$core$Tuple$mapFirst,
				$author$project$Breakers$Utils$segmentsToContent,
				A3($author$project$Main$Update$BreakFile$selectFileChangesHelper, config, segments, _List_Nil)));
	});
...
var $author$project$Parsers$Elixir$blockComment = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
		A3($elm$parser$Parser$multiComment, '@moduledoc \"\"\"', '\"\"\"', $elm$parser$Parser$NotNestable)),
...
var $author$project$Parsers$Go$blockComment = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
...
var $author$project$Parsers$Rust$blockComment = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
...
var $author$project$Parsers$Elixir$comment = $elm$parser$Parser$lineComment('#');
var $author$project$Parsers$Elm$comment = $elm$parser$Parser$lineComment('--');
var $author$project$Parsers$Go$comment = $elm$parser$Parser$lineComment('//');
...
var $author$project$Parsers$Rust$comment = $elm$parser$Parser$lineComment('//');
...
var $author$project$Parsers$JavaScript$fatArrowFunctionDeclaration = $elm$parser$Parser$backtrackable(
	A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
				...
				A2(
					...
					$elm$parser$Parser$getChompedString(
						$elm$parser$Parser$oneOf(
							_List_fromArray(
								[
									$elm$parser$Parser$token('const'),
									$elm$parser$Parser$token('let'),
									$elm$parser$Parser$token('var')
								]))),
					$elm$parser$Parser$token(' '))),
			A2(
				$elm$parser$Parser$ignorer,
		...
		A2(
			...
			$elm$parser$Parser$token(') => '))));
var $author$project$Parsers$Elixir$functionDeclaration = $elm$parser$Parser$backtrackable(
	A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
	...
	A2(
		...
		A2(
			...
			A2(
				...
				$author$project$Parsers$Utils$Code$word),
			$elm$parser$Parser$token(' ='))));
var $author$project$Parsers$Utils$Code$anythingButCommasOrParens = $elm$parser$Parser$getChompedString(
	$author$project$Parsers$Utils$Repeat$oneOrMore(
...
var $author$project$Parsers$Go$functionDeclaration = $elm$parser$Parser$backtrackable(
	A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
		...
		A2(
			$elm$parser$Parser$ignorer,
			A2($author$project$Parsers$Utils$Repeat$zeroOrMoreWithSeparator, $author$project$Parsers$Utils$Repeat$commaSeparator, $author$project$Parsers$Utils$Code$anythingButCommasOrParens),
			$elm$parser$Parser$token(')'))));
...
var $author$project$Parsers$Ruby$functionDeclaration = $elm$parser$Parser$backtrackable(
	A2(
		...
		A2(
			...
			A2($author$project$Parsers$Utils$Repeat$zeroOrMoreWithSeparator, $author$project$Parsers$Utils$Repeat$commaSeparator, $author$project$Parsers$Utils$Code$word),
			$elm$parser$Parser$token(')'))));
var $author$project$Parsers$Rust$functionDeclaration = $elm$parser$Parser$backtrackable(
	A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
					...
					function () {
						switch (fileType.$) {
							case 'JavaScript':
								return _List_fromArray(
									[
										...
										A2($author$project$Parsers$Generic$Parser$mapFunctionDeclarationToSegment, offset, $author$project$Parsers$JavaScript$fatArrowFunctionDeclaration)
									]);
							case 'Python':
								return _List_fromArray(
									[
							...
							case 'Elixir':
								return _List_fromArray(
									[
										A3($author$project$Parsers$Generic$Parser$mapStringToSegment, offset, $author$project$Parsers$Generic$Segment$Comment, $author$project$Parsers$Elixir$comment),
										A3($author$project$Parsers$Generic$Parser$mapStringToSegment, offset, $author$project$Parsers$Generic$Segment$Comment, $author$project$Parsers$Elixir$blockComment),
										A2($author$project$Parsers$Generic$Parser$mapFunctionDeclarationToSegment, offset, $author$project$Parsers$Elixir$functionDeclaration)
									]);
							case 'Rust':
								return _List_fromArray(
									[
										A3($author$project$Parsers$Generic$Parser$mapStringToSegment, offset, $author$project$Parsers$Generic$Segment$Comment, $author$project$Parsers$Rust$comment),
										A3($author$project$Parsers$Generic$Parser$mapStringToSegment, offset, $author$project$Parsers$Generic$Segment$Comment, $author$project$Parsers$Rust$blockComment),
										A2($author$project$Parsers$Generic$Parser$mapFunctionDeclarationToSegment, offset, $author$project$Parsers$Rust$functionDeclaration)
									]);
							case 'Go':
								return _List_fromArray(
									[
										A3($author$project$Parsers$Generic$Parser$mapStringToSegment, offset, $author$project$Parsers$Generic$Segment$Comment, $author$project$Parsers$Go$comment),
										A3($author$project$Parsers$Generic$Parser$mapStringToSegment, offset, $author$project$Parsers$Generic$Segment$Comment, $author$project$Parsers$Go$blockComment),
										A2($author$project$Parsers$Generic$Parser$mapFunctionDeclarationToSegment, offset, $author$project$Parsers$Go$functionDeclaration)
									]);
							default:
								return _List_fromArray(
									[
...
var $author$project$Main$Update$BreakFile$run = function (config) {
	var filepath = config.filepath;
	var fileContent = config.fileContent;
	var fileType = $author$project$Utils$Types$FileType$fromFilePath(filepath);
	return $elm$core$Result$toMaybe(
		A2(
			$elm$core$Result$map,
			$author$project$Main$Update$BreakFile$randomlySelectFileChangesFromParsedSegments(config),
			A2($author$project$Parsers$Generic$Parser$run, fileType, fileContent)));
};
var $author$project$Utils$DummyData$defaultBrokenFile = function (randomNumbers) {
	var result = $author$project$Main$Update$BreakFile$run(
		{breakCount: 3, fileContent: $author$project$Utils$DummyData$defaultFileContent, filepath: $author$project$Utils$DummyData$defaultFilePath, randomNumbers: randomNumbers});
	if (result.$ === 'Just') {
		...
		return {
			changes: A2(
				...
				changes),
			originalContent: $author$project$Utils$DummyData$defaultFileContent,
			path: $author$project$Utils$DummyData$defaultFilePath,
...
var $author$project$Utils$DummyData$debuggingStageStepsPage = function (randomNumbers) {
...
var $author$project$Utils$DevModeStartState$get = function (numbers) {
	return $author$project$Utils$DummyData$debuggingStageStepsPage(numbers);
};
...
var $author$project$Main$init = function (flags) {
	var _v0 = function () {
		...
		if (_v1.$ === 'Ok') {
			...
			var logo = _v1.a.logo;
			var mode = _v1.a.mode;
			return {appMode: mode, logoPath: logo, numbers: randomNumbers, startingError: $elm$core$Maybe$Nothing};
		} else {
			var error = _v1.a;
			return {
				appMode: $author$project$Utils$Types$AppMode$Production,
				...
				startingError: $elm$core$Maybe$Just(
					$author$project$Utils$Types$Error$decoding(
						{action: 'initial flag decoding', descriptionForUsers: 'Something went wrong loading ' + $author$project$Utils$Constants$appName, error: error, inModule: 'Main'}))
			};
		}
	}();
	...
	return _Utils_Tuple2(
		{
			...
			stage: function () {
				if (appMode.$ === 'Production') {
					return $author$project$Main$Model$Intro;
				} else {
					return $author$project$Utils$DevModeStartState$get(numbers);
				}
			}()
		},
...
var $author$project$Main$Msg$ChooseFileInterface = function (a) {
	return {$: 'ChooseFileInterface', a: a};
};
var $author$project$Main$Msg$DebuggingInterface = function (a) {
	return {$: 'DebuggingInterface', a: a};
};
var $author$project$Main$Msg$FinishedInterface = function (a) {
	return {$: 'FinishedInterface', a: a};
};
...
var $author$project$Stages$ChooseFile$Msg$BreakFile = function (a) {
	return {$: 'BreakFile', a: a};
};
var $author$project$Stages$ChooseFile$Msg$ChooseFile = {$: 'ChooseFile'};
var $author$project$Stages$ChooseFile$Msg$UpdateBugCount = function (a) {
...
var $author$project$Utils$UI$Text$code = function (string) {
	return A2($author$project$Utils$UI$Text$codeWithAttrs, _List_Nil, string);
};
...
var $author$project$Utils$Colors$darkKickstartCodingBlue = A3($mdgriffith$elm_ui$Element$rgb255, 20, 140, 204);
...
var $author$project$Stages$ChooseFile$View$howToStartNote = function (requestedBugCount) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				'Click \"' + ($author$project$Stages$ChooseFile$View$startButtonText + ('\" to add the ' + (A2($author$project$Utils$Pluralize$singularOrPlural, requestedBugCount, 'bug') + ' and start debugging.'))))
			]));
};
...
var $author$project$Utils$Types$FilePath$nameOnly = function (_v0) {
	var string = _v0.a;
	return A2(
		$elm$core$Maybe$withDefault,
		string,
...
var $author$project$Utils$UI$Attributes$title = function (string) {
	return $mdgriffith$elm_ui$Element$htmlAttribute(
		$elm$html$Html$Attributes$title(string));
};
var $author$project$Stages$ChooseFile$View$render = function (_v0) {
	var requestedBugCount = _v0.requestedBugCount;
	var status = _v0.status;
	var _v1 = function () {
		if (status.$ === 'JustStarted') {
			return {fileSelectLabel: 'choose a file', startButton: $mdgriffith$elm_ui$Element$none};
		} else {
			var file = status.a;
			return {
				...
				startButton: A2(
						...
						]),
					{
						...
						name: $author$project$Stages$ChooseFile$View$startButtonText
					})
			};
		}
	}();
	var fileSelectLabel = _v1.fileSelectLabel;
	var startButton = _v1.startButton;
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				function () {
					if (status.$ === 'JustStarted') {
						...
						return $author$project$Stages$ChooseFile$View$howToStartNote(requestedBugCount);
					}
				}())
			]),
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text('What file should I put the bugs in?')
								])),
							A2(
							$mdgriffith$elm_ui$Element$paragraph,
							_List_Nil,
							_List_fromArray(
								[
									...
									if (status.$ === 'GotFile') {
										var file = status.a;
										return $author$project$Utils$UI$Text$code(
											$author$project$Utils$Types$FilePath$nameOnly(file.path));
									} else {
										return $author$project$Utils$UI$Text$code('[no file selected yet]');
									}
								}()
								])),
							A2(
					...
					_List_fromArray(
						[
								...
								]),
							{
								...
								text: $elm$core$String$fromInt(requestedBugCount)
							})
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
...
var $author$project$Stages$Debugging$View$HelpTabs$DebuggingTips$tipColumn = F2(
...
var $author$project$Stages$Debugging$View$HelpTabs$DebuggingTips$tip = F2(
	function (attrs, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($author$project$Stages$Debugging$View$HelpTabs$DebuggingTips$tipColumn, attrs, content)
			]);
	});
var $author$project$Stages$Debugging$View$HelpTabs$DebuggingTips$defaultTip = A2(
			...
			_List_Nil,
			{
				content: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('You might be surprised at the things you\'ll notice about your code after taking a break.')
							]))
					]),
			...
			_List_Nil,
			{
				content: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('One of the best ways to learn and figure things out is to get help from friends and community.')
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Finding people and communities who can answer questions you have and offer encouragement when stuff is hard is so, so important.')
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Don\'t believe the individualism hype: it is both hard and pointless to force yourself to do this all on your own.')
							]))
					]),
...
var $author$project$Stages$Debugging$View$HelpPage$renderTab = function (_v0) {
	var tab = _v0.tab;
	...
	var _v1 = isActive ? {
		...
		styles: _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$color($author$project$Utils$Colors$darkGray),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Utils$Colors$darkGray),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Utils$Colors$veryLightGray)
			])
	};
	var borderWidthBottom = _v1.borderWidthBottom;
	var paddingBottom = _v1.paddingBottom;
	var styles = _v1.styles;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							{bottom: paddingBottom, left: 20, right: 20, top: 20})
						])),
				{
					label: $mdgriffith$elm_ui$Element$text(
						$author$project$Stages$Debugging$Model$helpTabToString(tab)),
					onPress: $elm$core$Maybe$Just(
						$author$project$Stages$Debugging$Msg$ChangeHelpTab(tab))
				}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Border$color($author$project$Utils$Colors$black),
						$mdgriffith$elm_ui$Element$Border$widthEach(
						{bottom: borderWidthBottom, left: 0, right: 0, top: 0})
					]),
					...
					[
						...
						_List_fromArray(
							[
								...
								{
									isActive: _Utils_eq($author$project$Stages$Debugging$Model$DebuggingTips, currentHelpTab),
									tab: $author$project$Stages$Debugging$Model$DebuggingTips
								}),
								$author$project$Stages$Debugging$View$HelpPage$renderTab(
								{
									isActive: _Utils_eq($author$project$Stages$Debugging$Model$BugHints, currentHelpTab),
									tab: $author$project$Stages$Debugging$Model$BugHints
								}),
								$author$project$Stages$Debugging$View$HelpPage$renderTab(
								{
									isActive: _Utils_eq($author$project$Stages$Debugging$Model$EncourageMe, currentHelpTab),
									tab: $author$project$Stages$Debugging$Model$EncourageMe
								}),
								$author$project$Stages$Debugging$View$HelpPage$renderTab(
								{
						...
						switch (currentHelpTab.$) {
							...
							case 'BugHints':
								return $author$project$Stages$Debugging$View$HelpTabs$BugHints$render(
									{brokenFile: brokenFile, requestedBugCount: requestedBugCount});
							case 'EncourageMe':
								return $author$project$Stages$Debugging$View$HelpTabs$Encouragement$render(
									{brokenFile: brokenFile, encouragements: encouragements, requestedBugCount: requestedBugCount});
							default:
								return $author$project$Stages$Debugging$View$HelpTabs$ShowMeTheAnswer$render(brokenFile);
						}
					}()
					]))
			]));
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$text(
										$author$project$Utils$Types$FilePath$nameOnly(path))),
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text('If you think this might be it, try rerunning Debug Trainer to introduce a different error.')
								])),
							A2(
							$author$project$Utils$UI$Buttons$button,
							_List_fromArray(
...
var $author$project$Stages$Debugging$View$StepsPage$render = F2(
	function (requestedBugCount, _v0) {
		var changes = _v0.changes;
		var path = _v0.path;
		var changeCount = $elm$core$List$length(changes);
		var couldNotFindEnoughPossibleBugs = _Utils_cmp(changeCount, requestedBugCount) < 0;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					A2(
						...
						'I put ' + ($elm$core$String$fromInt(changeCount) + (' ' + (A2($author$project$Utils$Pluralize$singularOrPlural, changeCount, 'bug') + (' in `' + ($author$project$Utils$Types$FilePath$nameOnly(path) + ('`' + ((couldNotFindEnoughPossibleBugs ? (' (sorry I couldn\'t get to ' + ($elm$core$String$fromInt(requestedBugCount) + (' ' + (A2($author$project$Utils$Pluralize$singularOrPlural, requestedBugCount, 'bug') + '; I couldn\'t find enough buggable things in the code 😢)')))) : '') + ('! Can you figure out where ' + ($author$project$Utils$Pluralize$itIsOrTheyAre(changeCount) + '?'))))))))))),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
...
var $author$project$Stages$Debugging$View$render = function (_v0) {
	...
	switch (currentPage.$) {
		case 'StepsPage':
			return A2($author$project$Stages$Debugging$View$StepsPage$render, requestedBugCount, brokenFile);
		case 'HelpPage':
			return $author$project$Stages$Debugging$View$HelpPage$render(
				{brokenFile: brokenFile, currentDebuggingTip: currentDebuggingTip, currentHelpTab: currentHelpTab, encouragements: encouragements, requestedBugCount: requestedBugCount});
		default:
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Stages$Finished$View$renderCodeLine(focusedLine),
					A2($author$project$Stages$Finished$View$getNearbyLines, focusedLine, content)))
			]));
};
var $author$project$Stages$Finished$View$renderChange = F3(
	function (brokenFile, index, _v0) {
		...
		return A2(
			...
			_List_fromArray(
				[
							...
							$author$project$Utils$UI$Text$codeWithAttrs(
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$Border$rounded(3),
										$mdgriffith$elm_ui$Element$Background$color(
										$author$project$Utils$Colors$lightened(0.8))
									])),
							changeDescription),
						_List_fromArray(
							[
					...
					_List_fromArray(
						[
							$author$project$Stages$Finished$View$labeledCodeSnippet(
...
var $author$project$Stages$Intro$View$kickstartLink = function (logoPath) {
	return A2(
		$author$project$Utils$UI$Link$render,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Stages$Intro$View$kickstartLink(logoPath)
							]))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('step 2: ')),
								$mdgriffith$elm_ui$Element$text('you try to figure out the bug with the help of hints and advice from ' + $author$project$Utils$Constants$appName)
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$Font$bold]),
								$mdgriffith$elm_ui$Element$text('step 3: ')),
								$mdgriffith$elm_ui$Element$text($author$project$Utils$Constants$appName + ' will return your file to its original working version when you\'re done')
							]))
					])),
				A2(
				$author$project$Utils$UI$Buttons$button,
						...
						function () {
							if (maybeError.$ === 'Just') {
								...
								return A2(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text(error.descriptionForUsers)
										]));
							} else {
								return $mdgriffith$elm_ui$Element$none;
							}
					...
					switch (stage.$) {
						...
						case 'ChooseFile':
							...
							return A2(
								...
								$author$project$Main$Msg$ChooseFileInterface,
								$author$project$Stages$ChooseFile$View$render(
									{requestedBugCount: requestedBugCount, startType: startType, status: status}));
						case 'Debugging':
							...
							return A2(
								...
								$author$project$Stages$Debugging$View$render(
									{brokenFile: brokenFile, currentDebuggingTip: currentDebuggingTip, currentHelpTab: currentHelpTab, currentPage: currentPage, encouragements: encouragements, requestedBugCount: requestedBugCount}));
						default:
							var finishModel = stage.a;
							return A2(
								$mdgriffith$elm_ui$Element$map,
								$author$project$Main$Msg$FinishedInterface,
								$author$project$Stages$Finished$View$render(finishModel));
					}
				}())
			]),
		title: $author$project$Utils$Constants$appName
	};
};
var $author$project$Main$Msg$FileWasBroken = {$: 'FileWasBroken'};
var $author$project$Stages$ChooseFile$Msg$FileWasSelected = function (a) {
...
var $author$project$Main$Interop$interopToElm = _Platform_incomingPort('interopToElm', $elm$json$Json$Decode$value);
var $author$project$Main$Interop$FileChangeWasSaved = function (a) {
	return {$: 'FileChangeWasSaved', a: a};
};
...
var $author$project$Stages$ChooseFile$Model$File = F2(
...
var $author$project$Main$Definitions$gotFileChoice = A2(
	...
	A2(
		...
		$dillonkearns$elm_ts_json$TsJson$Decode$succeed($author$project$Stages$ChooseFile$Model$File)));
var $author$project$Main$Interop$toElmVariant = F3(
	function (tagName, constructor, decoder____) {
		return A2(
			$dillonkearns$elm_ts_json$TsJson$Decode$andMap,
			A2($dillonkearns$elm_ts_json$TsJson$Decode$field, 'data', decoder____),
			A2(
				$dillonkearns$elm_ts_json$TsJson$Decode$field,
				'tag',
				A2(
...
var $author$project$Main$Interop$toElmDecoder____ = $dillonkearns$elm_ts_json$TsJson$Decode$oneOf(
	_List_fromArray(
		[
			A3($author$project$Main$Interop$toElmVariant, 'gotFileChoice', $author$project$Main$Interop$GotFileChoice, $author$project$Main$Definitions$gotFileChoice),
			A3($author$project$Main$Interop$toElmVariant, 'fileChangeWasSaved', $author$project$Main$Interop$FileChangeWasSaved, $author$project$Main$Definitions$fileChangeWasSaved)
		]));
var $author$project$Main$Interop$toElm = $author$project$Main$Interop$interopToElm(
	$elm$json$Json$Decode$decodeValue(
		$dillonkearns$elm_ts_json$TsJson$Decode$decoder($author$project$Main$Interop$toElmDecoder____)));
var $author$project$Main$Subscriptions$subscriptions = function (model) {
	return A2(
		...
		function (toElm) {
			if (toElm.$ === 'Ok') {
				if (toElm.a.$ === 'GotFileChoice') {
					var file = toElm.a.a;
					return $author$project$Main$Msg$ChooseFileInterface(
						$author$project$Stages$ChooseFile$Msg$FileWasSelected(file));
				} else {
					return $author$project$Main$Msg$FileWasBroken;
				}
			} else {
				var error = toElm.a;
				return $author$project$Main$Msg$InteropError(error);
			}
		},
...
var $author$project$Main$Interop$encodeProVariant = F3(
...
var $author$project$Main$Update$breakFile = F3(
	function (_v0, model, beginningCmd) {
		...
		var content = _v0.content;
		var result = $author$project$Main$Update$BreakFile$run(
			{breakCount: model.requestedBugCount, fileContent: content, filepath: path, randomNumbers: model.randomNumbers});
		if (result.$ === 'Just') {
			var newFileContent = result.a.newFileContent;
			var changes = result.a.changes;
			return _Utils_Tuple2(
				...
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2($elm$core$Platform$Cmd$map, $author$project$Main$Msg$ChooseFileInterface, beginningCmd),
							...
							$author$project$Utils$Types$Error$misc(
								{
									...
									descriptionForUsers: 'couldn\'t find any ways to break ' + $author$project$Utils$Types$FilePath$toString(path),
									error: 'no known ways to break ' + $author$project$Utils$Types$FilePath$toString(path),
...
var $author$project$Stages$ChooseFile$Update$UpdateBugCountInstruction = function (a) {
...
var $author$project$Stages$ChooseFile$Update$update = function (_v0) {
	var model = _v0.model;
	var msg = _v0.msg;
	switch (msg.$) {
		case 'UpdateBugCount':
			...
			if (_v2.$ === 'Just') {
				var requestedBugCount = _v2.a;
				return A2(
					$author$project$Utils$BubbleUp$withInstruction,
					$author$project$Stages$ChooseFile$Update$UpdateBugCountInstruction(requestedBugCount),
					$author$project$Utils$BubbleUp$justModel(model));
			} else {
				return A2(
					$author$project$Utils$BubbleUp$withMiscError,
					{action: 'UpdateBugCount', descriptionForUsers: 'it looks like you somehow entered a bug count that isn\'t a valid number', error: 'Couldn\'t parse the bug count', inModule: 'Stages.ChooseFile.Update'},
					$author$project$Utils$BubbleUp$justModel(model));
			}
		case 'ChooseFile':
			return A2(
		...
		case 'FileWasSelected':
			...
			return $author$project$Utils$BubbleUp$justModel(
				_Utils_update(
					model,
					{
						status: $author$project$Stages$ChooseFile$Model$GotFile(file)
					}));
		default:
			var file = msg.a;
			return A2(
				$author$project$Utils$BubbleUp$withInstruction,
				$author$project$Stages$ChooseFile$Update$BreakFileInstruction(file),
				$author$project$Utils$BubbleUp$justModel(model));
	}
};
...
var $author$project$Stages$Debugging$Model$showBugTypeHint = function (_v0) {
	var change = _v0.a;
	var hintVisibility = _v0.b;
	return _Utils_Tuple2(
		change,
...
var $author$project$Stages$Debugging$Model$updateChange = F3(
	function (index, updateFunc, model) {
		var brokenFile = model.brokenFile;
		var newChanges = A3($elm_community$list_extra$List$Extra$updateAt, index, updateFunc, brokenFile.changes);
		var newBrokenFile = _Utils_update(
			brokenFile,
			{changes: newChanges});
		return _Utils_update(
			model,
...
var $author$project$Stages$Finished$Update$Exit = {$: 'Exit'};
var $author$project$Stages$Finished$Update$PlayAgain = {$: 'PlayAgain'};
var $author$project$Stages$Finished$Update$ResetFile = function (a) {
	return {$: 'ResetFile', a: a};
};
var $author$project$Stages$Finished$Update$update = function (_v0) {
	var model = _v0.model;
	var msg = _v0.msg;
	if (msg.$ === 'ResetFileAndExit') {
		return A2(
			$author$project$Utils$BubbleUp$withInstruction,
			$author$project$Stages$Finished$Update$ResetFile($author$project$Stages$Finished$Update$Exit),
			$author$project$Utils$BubbleUp$justModel(model));
	} else {
		return A2(
			$author$project$Utils$BubbleUp$withInstruction,
...
var $author$project$Main$Interop$writeFileAndExit = function (argument____) {
	return $author$project$Main$Interop$interopFromElm(
		A3($author$project$Main$Interop$encodeProVariant, 'writeFileAndExit', $author$project$Main$Definitions$writeFileAndExit, argument____));
};
		...
		switch (msg.$) {
			...
			case 'ChooseFileInterface':
				...
				if (_v1.$ === 'ChooseFile') {
					...
					var _v2 = $author$project$Stages$ChooseFile$Update$update(
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										...
										stage: $author$project$Main$Model$ChooseFile(newModel)
									}),
								A2($elm$core$Platform$Cmd$map, $author$project$Main$Msg$ChooseFileInterface, cmd));
						} else {
							var file = _v3.a.a;
						...
						if (_v6.a.$ === 'GoToFinishStage') {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										stage: $author$project$Main$Model$ChooseFile(
											$author$project$Stages$ChooseFile$Model$afterResetInit(debuggingModel.brokenFile))
									}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
						...
						if (playPreference.$ === 'PlayAgain') {
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										stage: $author$project$Main$Model$ChooseFile(
											$author$project$Stages$ChooseFile$Model$afterResetInit(brokenFile))
									}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										stage: $author$project$Main$Model$Finished(newModel)
									}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($elm$core$Platform$Cmd$map, $author$project$Main$Msg$FinishedInterface, cmd),
											$author$project$Main$Interop$writeFileAndExit(
											{content: brokenFile.originalContent, path: brokenFile.path})
										])));
						}
					} else {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							maybeError: $elm$core$Maybe$Just(
								$author$project$Utils$Types$Error$decoding(
									{action: 'InteropError', descriptionForUsers: 'it looks like you found a bug in the ' + ($author$project$Utils$Constants$appName + ' app'), error: error, inModule: 'Main.Update'}))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$main = $elm$browser$Browser$document(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$Subscriptions$subscriptions, update: $author$project$Main$Update$update, view: $author$project$Main$View$render});
