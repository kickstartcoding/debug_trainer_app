...
var $author$project$Main$Msg$UpdateFileCount = function (a) {
	return {$: 'UpdateFileCount', a: a};
};
					...
					_List_fromArray(
						[
								...
								]),
							{
								...
								onChange: $author$project$Main$Msg$UpdateFileCount,
								placeholder: $elm$core$Maybe$Nothing,
								text: $elm$core$String$fromInt(model.fileCount)
							}),
							$mdgriffith$elm_ui$Element$text(' bugs ')
						])))
			]),
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{
		...
		update: $author$project$Main$Update$update,
		view: $author$project$Main$View$render
	});
